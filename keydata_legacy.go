...
//
// This is deprecated where [Version] returns greater than 1, and will return an error.
// The value returned by [Version] is indirectly protected because its used to decide
...
func (d *KeyData) IsSnapModelAuthorized(key PrimaryKey, model SnapModel) (bool, error) {
	...
	case 2:
		return false, errors.New("unsupported key data version")
	default:
		return false, fmt.Errorf("invalid keydata version %d", d.Version())
	}
}
...
func (d *KeyData) SetAuthorizedSnapModels(key PrimaryKey, models ...SnapModel) (err error) {
	...
	case 1:
		...
		return nil
	case 2:
		return errors.New("unsupported key data version")
	default:
		return fmt.Errorf("invalid keydata version %d", d.Version())
	}
}
